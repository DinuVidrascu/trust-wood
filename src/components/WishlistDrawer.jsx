...
export default function WishlistDrawer() {
  ...
  const calculateTotal = () => {
    return wishlist.reduce((acc, item) => {
      // Remove spaces from price string to parse it as number
  ...
  return (
    <>
      {/* DRAWER BACKDROP */}
      <div className="wd-backdrop" onClick={toggleDrawer}></div>
        ...
        <div className="wd-content">
          {wishlist.length === 0 ? (
            <div className="wd-empty">
              ...
              <button className="btn-premium" onClick={toggleDrawer} style={{ marginTop: '20px', width: '100%' }}>
            ...
            <div className="wd-list-wrap">
              ...
              <div className="wd-footer">
                ...
                <div className="wd-actions">
                  ...
                  <button className="btn-premium wd-btn" onClick={() => setModalOpen(true)}>
